...
int main(void) {
    ...
    // REDO FIX: test NULL-tree guards
    printf("\n=== NULL tree guard tests ===\n");
    u_int8_t null_remove = remove_str_from_tree(NULL, "test");
    printf("remove_str_from_tree(NULL, \"test\") returned: %u\n", null_remove);
    delete_tree(NULL);
    printf("delete_tree(NULL) returned safely\n");
