...
int32_t negate(int32_t x){
    // We cast to unsigned to perform the bitwise NOT and addition in well-defined unsigned arithmetic.
    // When x is INT32_MIN, we compute ~0x80000000 + 1 = 0x80000000 (all in uint32_t, no overflow).
